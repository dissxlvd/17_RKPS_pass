...
Учебная Виртуальная Машина (далее УВМ) имеет порядок байтов little-endian, что означает что наименее значимые биты записываются первыми. Например число 342 будет записано как:
...
<tr>
	<td>big-endian</td>
	<td>00000001 01010110</td>
	<td>0x01 0x56</td>
</tr>
<tr>
	<td>little-endian</td>
	<td><b>01010110 00000001</b></td>
	<td>0x56 0x01</td>
</tr>
<table>
